...
#It's for the two UAVs' position mode
import rospy
...
if __name__ == "__main__":
    ...
    uavVeloSub0 = rospy.Subscriber('/outer_control_0/twist', TwistStamped, velocity_cb, queue_size=10)
    ...
    uavVeloSub1 = rospy.Subscriber('/outer_control_1/twist', TwistStamped, velocity_cb, queue_size=10)
    ...
    pose0.pose.position.x = -0.43
    pose0.pose.position.y = 0.78
    pose0.pose.position.z = 0.8
    pose1.pose.position.x = -0.43
    ...
    rospy.loginfo("go to the arm part")
